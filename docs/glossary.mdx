...
<GlossaryEntry term="Toe-clip Code 🐾" definition={<><p>A method used in wildlife biology to uniquely mark small animals by clipping their toes in a specific pattern. This method helps in identifying individual animals during recapture.</p><p>See the <a href="./toe-clip-codes">toe-clip code page</a> for formatting and reuse guidance.</p></>} field="biology" />
